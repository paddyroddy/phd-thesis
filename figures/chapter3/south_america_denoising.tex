\begin{figure}[htp]
	...
	\subfloat[Initial Noisy Data \newline
		\(\snr{x} = \SI{4.11}{\dB}\)]
	{\includegraphics[trim={23 7 3 6},clip,width=.5\textwidth]{chapter3/slepian_south_america_-10noise_2smoothed_L128_res512_real.pdf}}
	\hfill
	\subfloat[Denoised \(N_{\sigma}=2\) \newline
		\(\snr{d} = \SI{5.67}{\dB}\)]
	{\includegraphics[trim={23 7 3 6},clip,width=.5\textwidth]{chapter3/slepian_south_america_2smoothed_L128_-10snr_2n_denoised_res512_real.pdf}}
	\newline
	\subfloat[Denoised \(N_{\sigma}=3\) \newline
		\(\snr{d} = \SI{4.60}{\dB}\)]
	{\includegraphics[trim={23 7 3 6},clip,width=.5\textwidth]{chapter3/slepian_south_america_2smoothed_L128_-10snr_3n_denoised_res512_real.pdf}}
	\hfill
	\subfloat[Denoised \(N_{\sigma}=5\) \newline
		\(\snr{d} = \SI{1.27}{\dB}\)]
	{\includegraphics[trim={23 7 3 6},clip,width=.5\textwidth]{chapter3/slepian_south_america_2smoothed_L128_-10snr_5n_denoised_res512_real.pdf}}
	\caption{
