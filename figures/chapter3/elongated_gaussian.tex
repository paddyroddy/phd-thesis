\begin{figure}[htpb]
	...
	\caption[
		...
		\hl{Presented in panel (a) is} the elongated Gaussian \hl{with parameters \mbox{\((\mean{\theta},\mean{\phi},\sigma_{\theta},\sigma_{\phi}) = (0,\pi,10^{0},10^{-1})\)}} on the north pole (bandlimited at \(L=128\)), \hl{\cf{} \mbox{\cref{eq:chapter3_elongated_gaussian}}} --- where the central bar in the plot extends over half of the sphere.
