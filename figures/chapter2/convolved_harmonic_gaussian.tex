\begin{figure}[htp]
	\centering
	\subfloat[\(\Re{\pixel{\convolution{f_{A}}{g}}}\)]{\includegraphics[trim={22 9 7 6},clip,width=.5\textwidth]{chapter2/harmonic_gaussian_100lsig_10msig_L128_convolved_earth_L128_res512_real_norm.pdf}}
	\hfill
	\subfloat[\(\Re{\pixel{\convolution{f_{B}}{g}}}\)]{\includegraphics[trim={22 9 7 6},clip,width=.5\textwidth]{chapter2/harmonic_gaussian_10lsig_10msig_L128_convolved_earth_L128_res512_real_norm.pdf}}
	\caption{
