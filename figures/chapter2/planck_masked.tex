\begin{figure}[htpb]
	...
	\caption[
		...
		The Planck \texttt{Commander}~\cite{Eriksen2004,Eriksen2008,Planck2016} CMB temperature map used in low-\(\ell{}\) temperature likelihood analysis, smoothed to \(\SI{60}{\arcminute}\) FWHM resolution (courtesy of The Planck Collaboration 2018~\cite{Planck2020a}).
