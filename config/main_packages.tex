...
\usepackage{pgfplots}
\pgfplotsset{compat=1.18} % <- this fixed axis labels in the version I was using
...
%  make a single figure with 4 individually labelled and referenceable
%  sub-figures.
...
% add appendix before title in table of contents
