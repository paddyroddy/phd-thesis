...
Upon selection of a suitable kernel, convolutions have enjoyed success in many applications, such as: smoothing~\cite{Gorry1990}, sharpening~\cite{Hu2020}, high pass filtering~\cite{Huang2009}, differentiation~\cite{Gorry1990}, and edge detection~\cite{Shen1996}.  % typos: ignore
Initially developed in the one-dimensional Euclidean domain, convolutions have since been used extensively in the two-dimensional setting, primarily for images~\cite{Rahmouni2017,Unser1995,Sahiner1996,Kumar2020}.  % typos: ignore
