...
Usually the manifold is sampled at \(n\) points, a graph is then constructed on these points (vertices) where the edges represent the local connectivity of the manifold.
...
\end{equation}
%
however, this does not capture the geometry of continuous underlying manifold.
By introducing an additional structure of faces \(\mathcal{F} \in \vertices \times \vertices \times \vertices\), one can construct a geometrically consistent discretisation as possible.
