...
Inspired by recent interest in geometric deep learning, this work generalises the previously defined Slepian scale-discretised wavelets on the sphere to Riemannian manifolds.
...
A tiling of the Slepian line defines the wavelets through smooth generating functions --- in an identical manner to \cref{sec:chapter3_generating_functions}.
A smoothly decreasing function \(k_{\lambda}\), defined in~\cite{Wiaux2008}, is unity for \(t < 1/\lambda\), zero for \(t > 1\), and smoothly decreasing in between.
