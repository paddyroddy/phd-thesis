...
The sifting convolution~\autocite{Roddy2021}, discussed in \cref{sec:chapter3}, is such a convolution.
...
The sifting convolution~\autocite{Roddy2021}, discussed in \cref{sec:chapter3}, is first extended to the Slepian basis in \cref{sec:chapter4_slepian_sifting_convolution}.
...
The sifting convolution on the sphere~\autocite{Roddy2021}, defined in \cref{sec:chapter3}, can be extended to any arbitrary basis.
...
To tile the Slepian line, consider the smooth generating functions defined by~\autocite{Wiaux2008}.
...
The current chapter generalises the \emph{sifting convolution}~\autocite{Roddy2021} on the sphere (introduced in \cref{sec:chapter3}) beyond the spherical harmonic setting to any basis, where here the Slepian functions define the basis.
