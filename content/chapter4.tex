...
The current chapter generalises the \emph{sifting convolution}~\autocite{Roddy2021} on the sphere beyond the spherical harmonic setting to any basis, where here the Slepian functions define the basis.
