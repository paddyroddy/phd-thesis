...
The Hilbert space \(\hilbert{\mathcal{M}}\) is formed by the set of functions \(f : \mathcal{M} \to \mathbb{R}\) which are square-integrable with respect to the Riemannian volume \(\dd{x}\).
