...
The complete set of orthonormal basis functions for the Hilbert space \(\hilbert{\twoSphere}\) are the spherical harmonics.
...
All computations are performed with the \texttt{SSHT}\cref{fn:ssht}~\cite{McEwen2011} and \texttt{S2LET}\footnote{\label{fn:s2let}\url{http://astro-informatics.github.io/s2let/}}~\cite{Leistedt2013} codes, on which the Slepian wavelet transforms on the sphere are built.
