...
By projecting the data onto an appropriate basis, patterns which were not readily apparent previously may present themselves.
If one seeks to find oscillatory features, then a Fourier basis is likely the most appropriate, \ie{} the spherical harmonics in the spherical setting.
Wavelets, however, simultaneously extract contribution of scale-dependent features in both space and scale.
Wavelets on manifolds have been successfully applied in fields such as: astrophysics and cosmology (sphere)~\cite{Pen1999,Barreiro2001,Rocha2004,McEwen2004}
