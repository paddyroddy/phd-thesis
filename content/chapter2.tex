...
However, much like likelihood-free inference discussed before, machine learning may also use the observed data directly~\cite{Chanda2021}, thus ignoring the mask altogether.
