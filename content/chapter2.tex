...
However, since the Fourier transform of a Dirac delta consists of all possible frequencies, and a convolution in the time domain corresponds to multiplication in the frequency domain, the signal would be smeared out on the frequency axis.
