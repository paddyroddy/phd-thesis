...
Starting from the left of \cref{fig:chapter2_power_spectrum}, the first obvious feature is the peak at an angular scale of \(\almost{1}\degree{}\) (\ie{} \(\ell \almost{200}\)).
...
As a result, the second peak is much lower than the first.
