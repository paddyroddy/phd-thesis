...
The spherical harmonics \(\pixel{\harmonic{Y}}\) with integer \(\ell \geq 0\) and integer \(m \leq \abs{\ell}\) form an orthonormal basis of the Hilbert space \(\hilbert{\twoSphere}\).
...
\begin{equation}
	...
	%
	+ \frac{1}{r^{2}\sin^{2}{\theta}} \pdv{\theta} \bigg(\sin{\theta} \pdv{\theta}\bigg)
	%
...
\begin{equation}
	...
	%
	+ \frac{1}{\Theta} \dv{\theta} \bigg(\sin{\theta} \dv{\Theta}{\theta}\bigg)
	%
