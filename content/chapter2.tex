...
Statistical isotropy and statistical homogeneity both eliminate three of these degrees of freedom.
...
The two-point function must be invariant under all rotations due to statistical isotropy, and hence
%
\begin{equation}
...
Consider projecting a random field \(f(\vb*{x})\) over a sphere of radius \(r\), centred on the origin, to form \(f(\omega) = f(r\omega)\).
Consider \(f(\omega)\) in Fourier space
%
\begin{equation}
	f(\omega)
	%
	= \int\frac{\dd[3]{\vb*{k}}}{{(2\pi)}^{3}} \fourier{f}(\vb*{k}) \exp(ikr\vu*{k}\cdot\omega),
\end{equation}
%
...
The spherical multipole coefficients of \(f(\omega)\) are therefore
%
\begin{align}
	\harmonic{f}
	%
	 & = \integrateSphere{\omega} f(\omega) \conj{\harmonic{Y}}(\omega) \nonumber{}                                                                                                                                                                                                         \\
	%
	 & = \integrateSphere{\omega} \int\frac{\dd[3]{\vb*{k}}}{{(2\pi)}^{3}} \fourier{f}(\vb*{k}) \exp(ikr\vu*{k}\cdot\omega) \conj{\harmonic{Y}}(\omega) \nonumber{}                                                                                                                         \\
	%
	 & = 4\pi \int\frac{\dd[3]{\vb*{k}}}{{(2\pi)}^{3}} \fourier{f}(\vb*{k}) \sum\limits_{\ell'=0}^{\infty} i^{\ell'} j_{\ell'}(kr) \sum\limits_{m'=-\ell'}^{\ell'} \conj{\harmonic[']{Y}}(\vu*{k}) \integrateSphere{\omega} \harmonic[']{Y}(\omega) \conj{\harmonic{Y}}(\omega) \nonumber{} \\
	%
	 & = 4\pi i^{\ell} \int\frac{\dd[3]{\vb*{k}}}{{(2\pi)}^{3}} \fourier{f}(\vb*{k}) j_{\ell}(kr) \conj{\harmonic{Y}}(\vu*{k}) \nonumber{}                                                                                                                                                  \\
	%
	 & = i^{\ell} \int\frac{\dd[3]{\vb*{k}}}{2\pi^{2}} \fourier{f}(\vb*{k}) j_{\ell}(kr) \conj{\harmonic{Y}}(\vu*{k}).
\end{align}
%
...
\begin{align}
	\expval*{\harmonic{f}\conj{\harmonic[']{f}}}
	%
	 & = i^{\ell-\ell'} \int\frac{\dd[3]{\vb*{k}}}{2\pi^{2}} \int\frac{\dd[3]{\vb*{k'}}}{2\pi^{2}} \expval*{\fourier{f}(\vb*{k}) \conj{\fourier{f}}(\vb*{k'})} j_{\ell}(kr) j_{\ell'}(k'r) \conj{\harmonic{Y}}(\vu*{k}) \harmonic[']{Y}(\vu*{k'}) \nonumber{} \\
	%
	 & = 4\pi i^{\ell-\ell'} \int\frac{\dd[3]{\vb*{k}}}{2\pi^{2}} \powerSpectrumDim{f} \delta^{3}(\vb*{k} - \vb*{k'}) j_{\ell}(kr) j_{\ell'}(k'r) \conj{\harmonic{Y}}(\vu*{k}) \harmonic[']{Y}(\vu*{k'}) \nonumber{}                                          \\
	%
	 & = 4\pi i^{\ell-\ell'} \int\frac{\dd[3]{\vb*{k}}}{2\pi^{2}} \powerSpectrumDim{f} j_{\ell}(kr) j_{\ell'}(kr) \conj{\harmonic{Y}}(\vu*{k}) \harmonic[']{Y}(\vu*{k}) \nonumber{}                                                                           \\
	%
...
\end{align}
%
Thus, \(f(\omega)\) is a statistically isotropic field with angular power spectrum
%
\begin{equation}
	\powerSpectrum
	%
...
The multipoles \({\ell}\) predominately probe the spatial structure in the three-dimensional fields \(F(\vb*{x})\) with wavenumber \(k \thicksim \ell/r\).
