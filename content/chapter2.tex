...
To compare theory and observation, one must measure statistical properties of the Universe, and compare these to a model of the Universe.
...
Here, only zero-mean fields are considered, such as the temperature fluctuations in the CMB
%
\begin{equation}
	\theta
	%
