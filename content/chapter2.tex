...
Sometimes one considers the power in a shell rather than per unit Fourier space volume
%
\begin{equation}
...
\end{equation}
%.
Similarly, the three-point correlator
%
\begin{equation}
	\expval*{f(\vb*{k}_{1}) f(\vb*{k}_{2}) f(\vb*{k}_{3})}
	%
	= {(2\pi)}^{3} \mathcal{B}_{f}(k_{1},k_{2},k_{3}) \delta^{3}(\vb*{k}_{1} + \vb*{k}_{2} + \vb*{k}_{3}),
\end{equation}
%
gives rise to the bispectrum \(\mathcal{B}_{f}(k_{1},k_{2},k_{3})\) which is a symmetric function (due to statistical isotropy) of the three wavenumbers.
