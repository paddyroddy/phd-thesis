...
Define the \emph{squashed Gaussian} as a Gaussian in real space modulated by a sinusoidal function in the azimuthal angle
%
\begin{equation}
	\pixel{\mathcal{SG}}
	%
...
The odd symmetry in the kernel definition has lead to the
...
\input{figures/chapter2/north_harmonic_gaussian}

\input{figures/chapter2/translated_harmonic_gaussian}
