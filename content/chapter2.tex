...
\cref{sec:chapter2_time_frequency_domain} follows with a brief review of the initial time-frequency concentration problem, this is then extended to the spherical domain in \cref{sec:chapter2_spatial_spectral_domain}.
...
\subsection{Spatial-Spectral Domain}\label{sec:chapter2_spatial_spectral_domain}
...
Naively, to remove this foreground, one may either interpolate missing values with the existing data or simply set the missing pixel values to zero.
