...
\begin{align}
	...
	%
	 & = \sum\limits_{\ell=0}^{\infty} \sum\limits_{m=-\ell}^{\ell} \sum\limits_{\ell'=0}^{\infty} \sum\limits_{m'=-\ell'}^{\ell'} C_{\ell} \delta_{\ell\ell'} \delta_{m m'} \harmonic{Y}(\vu*{n}) \conj{\harmonic[']{Y}}(\vu*{n'}) \nonumber{}     \\
	%
	 & = \sum\limits_{\ell=0}^{\infty} C_{\ell} \sum\limits_{m=-\ell}^{\ell} \harmonic{Y}(\vu*{n}) \conj{\harmonic{Y}}(\vu*{n'}) \nonumber{}                                                                                                        \\
	%
	 & = \sum\limits_{\ell=0}^{\infty} \factor C_{\ell} P_{\ell}(\vu*{n}\cdot\vu*{n'})  \nonumber{}                                                                                                                                                 \\
	%
	 & = C(\theta)
\end{align}
%
