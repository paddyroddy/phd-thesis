...
In tests the non-Gaussianity of the CMB, a suitable mask is applied to the data which (after a wavelet transform) contaminates the wavelet coefficients that overlap with it~\cite{Vielva2004,McEwen2004}.
