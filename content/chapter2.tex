...
A set of kernels are created and then translated in \cref{sec:chapter2_kernels}.
The convolution is then demonstrated with one of these kernels in \cref{sec:chapter2_conclusion} on a topographic map of the Earth.
