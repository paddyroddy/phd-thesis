...
Presented here is a brief review of wavelet analysis, for more detail see, \eg{}~\cite{Rioul1991,Graps1995,Valens1999,Kaiser2011}.
...
Thus, the CWT described in \cref{sec:chapter2_continuous_wavelet_transform} must be discretised as well.
Consider the multiresolution formulation~\cite{Burrus1997} or two-scale relation~\cite{Sheng2010}
%
\begin{equation}
	\Phi(2^{j}t)
	%
	= \sum\limits_{k} h^{j+1}(k) \Phi(2^{j+1}t - k).
\end{equation}
