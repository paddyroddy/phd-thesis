...
The angular diameter distance depends on how light rays converge or diverge --- corresponding to a Universe which is spatially closed or spatially open, respectively.
Hence, the angular location of this first peak indicates the geometry of the Universe.
Experimentally the Universe is found to be spatially flat to a \(1\sigma{}\) accuracy of \(2\%\)~\cite{Planck2020b}. % chktex 21
...
The second peak indicates large amounts of dark baryons, which is consistent with nucleosynthesis.
