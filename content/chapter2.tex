...
\cref{fig:chapter2_planck_masked} presents the Planck temperature map (\cf{} \cref{fig:chapter2_planck_frequency}) with the \texttt{Commander}~\cite{Eriksen2004,Eriksen2008,Planck2016} mask applied (in grey) which blocks out the foreground microwave emissions.
This masked map is used for likelihood analysis.
