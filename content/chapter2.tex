...
Consider projecting a random field \(f\) (\ie{} CMB temperature fluctuations) over a sphere of radius \(r\) (the distance to the surface of last scattering), centred on the origin.
...
\begin{align}
	...
	%
	 & = \sum\limits_{\ell=0}^{\infty} (2\ell+1) i^{\ell} j_{\ell}(k r) P_{\ell}(\vu*{k}\cdot\vu*{r}) \nonumber{}                                   \\
	%
	 & = 4\pi \sum\limits_{\ell=0}^{\infty} i^{\ell} j_{\ell}(k r) \sum\limits_{m=-\ell}^{\ell} \conj{\harmonic{Y}}(\vu*{k}) \harmonic{Y}(\vu*{r}),
\end{align}
%
where \(j_{l}(k r)\) are the spherical Bessel functions.
...
\begin{align}
	...
	%
	 & = \int\frac{\dd[3]{\vb*{k}}}{{(2\pi)}^{3}} \fourier{f}(\vb*{k}) \integrateSphere{\vu*{n}} \bigg[4\pi \sum\limits_{\ell'=0}^{\infty} i^{\ell'} j_{\ell'}(k r) \sum\limits_{m'=-\ell'}^{\ell'} \conj{\harmonic[']{Y}}(\vu*{k}) \harmonic[']{Y}(\vu*{n})\bigg] \conj{\harmonic{Y}}(\vu*{n}) \nonumber{} \\
	%
	 & = 4\pi i^{\ell} \int\frac{\dd[3]{\vb*{k}}}{{(2\pi)}^{3}} \fourier{f}(\vb*{k}) j_{\ell}(k r) \conj{\harmonic{Y}}(\vu*{k}) \nonumber{}                                                                                                                                                                 \\
	%
	 & = i^{\ell} \int\frac{\dd[3]{\vb*{k}}}{2\pi^{2}} \fourier{f}(\vb*{k}) j_{\ell}(k r) \conj{\harmonic{Y}}(\vu*{k}),
\end{align}
%
...
The two-point function of the \(\harmonic{f}\) is hence
%
\begin{align}
	\expval*{\harmonic{f}\conj{\harmonic[']{f}}}
	%
	 & = i^{\ell-\ell'} \int\frac{\dd[3]{\vb*{k}}}{2\pi^{2}} \int\frac{\dd[3]{\vb*{k'}}}{2\pi^{2}} \expval*{\fourier{f}(\vb*{k}) \conj{\fourier{f}}(\vb*{k'})} j_{\ell}(k r) j_{\ell'}(k'r) \conj{\harmonic{Y}}(\vu*{k}) \harmonic[']{Y}(\vu*{k'}) \nonumber{} \\
	%
	 & = \frac{i^{\ell-\ell'}}{\pi/2} \int\dd[3]{\vb*{k}} \int\dd[3]{\vb*{k'}} [\delta^{3}(\vb*{k} - \vb*{k'}) \powerSpectrumDim{f}] j_{\ell}(k r) j_{\ell'}(k'r) \conj{\harmonic{Y}}(\vu*{k}) \harmonic[']{Y}(\vu*{k'}) \nonumber{}                           \\
	%
	 & = \frac{i^{\ell-\ell'}}{\pi/2} \int\dd[3]{\vb*{k}} \powerSpectrumDim{f} j_{\ell}(k r) j_{\ell'}(k r) \conj{\harmonic{Y}}(\vu*{k}) \harmonic[']{Y}(\vu*{k}) \nonumber{}                                                                                  \\
	%
	 & = \frac{i^{\ell-\ell'}}{\pi/2} \bigg[\int\dd{k} k^{2} \integrateSphere{\vu*{k}}\bigg] \powerSpectrumDim{f} j_{\ell}(k r) j_{\ell'}(k r) \conj{\harmonic{Y}}(\vu*{k}) \harmonic[']{Y}(\vu*{k}) \nonumber{}                                               \\
	%
	 & = 4\pi i^{\ell-\ell'} \int\frac{\dd{k}}{k} \frac{k^{3}\powerSpectrumDim{f}}{2\pi^{2}} j_{\ell}(k r) j_{\ell'}(k r) \integrateSphere{\vu*{k}} \conj{\harmonic{Y}}(\vu*{k}) \harmonic[']{Y}(\vu*{k}) \nonumber{}                                          \\
	%
...
\end{equation}
%
The spherical Bessel functions have a sharp peak at \({k r = \ell}\) and for small arguments are \(\mathcal{O}{(k r)}^{\ell}\).
The multipoles \({\ell}\) predominately probe the spatial structure in the three-dimensional fields \(F(\vb*{x})\) with wavenumber \(k \almost{\ell/r}\).
...
Suppose that the observations of \(\omega{}\) that existed are full-sky and noise-free.
