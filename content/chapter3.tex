...
\begin{align}
	...
	%
	 & = \sum\limits_{m'=-\ell}^{\ell} g_{\ell m'} \integrateRotation{\rho} f(\rotationMatrix\eta) \wigner{\ell}{m}{m'}(\rho),
\end{align}
%
...
\begin{align}\label{eq:chapter3_so3_integral}
	\integrateRotation{\rho} f(\rotationMatrix\eta) \wigner{\ell}{m}{m'}(\rho)
	%
	 & = \integrateRotation{\rho} f(\rotationMatrix[']\eta) \wigner{\ell}{m}{m'}(\rho') \nonumber{}               \\
	%
	 & = \integrateRotation{\rho} f(\rotationMatrix\eta) \exp(-i m'\chi) \wigner{\ell}{m}{m'}(\rho) \nonumber{} \\
	%
	 & = \exp(-i m'\chi) \integrateRotation{\rho} f(\rotationMatrix\eta) \wigner{\ell}{m}{m'}(\rho),
\end{align}
%
