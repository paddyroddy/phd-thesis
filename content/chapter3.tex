...
By generalising the \emph{sifting convolution}~\autocite{Roddy2021}, discussed in \cref{sec:chapter2}, one may perform convolutions over the incomplete sphere using the Slepian functions as a basis.
...
\input{figures/chapter3/example_region_sphere}
...
as
%
\begin{align}\label{eq:chapter3_integrate_region_proof}
...
The sifting convolution~\autocite{Roddy2021} is first extended to the Slepian basis in \cref{sec:chapter3_slepian_sifting_convolution}.
...
The sifting convolution on the sphere~\autocite{Roddy2021}, defined in \cref{sec:chapter3_sifting_convolution_sphere}, can be extended to any arbitrary basis.
...
\input{figures/chapter3/south_america_tiling}
...
\input{figures/chapter3/south_america_region}
...
\input{figures/chapter3/south_america_slepian_functions}

\input{figures/chapter3/south_america_eigenvalues}
...
\input{figures/chapter3/south_america_wavelets}

\input{figures/chapter3/south_america_wavelet_coefficients}
...
%
\begin{equation}\label{eq:chapter3_signal_to_noise}
	\snr{x}
	%
...
\input{figures/chapter3/south_america_denoising}
