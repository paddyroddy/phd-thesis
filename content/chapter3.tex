...
This material is adapted from~\cite{Roddy2021a}.
...
By generalising the \emph{sifting convolution}~\cite{Roddy2021}, discussed in \cref{sec:chapter2}, one may perform convolutions over the incomplete sphere using the Slepian functions as a basis.
...
The sifting convolution on the sphere~\cite{Roddy2021}, defined in \cref{sec:chapter3_sifting_convolution_sphere}, can be extended to any arbitrary basis.
