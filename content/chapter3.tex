...
\begin{figure}[htp]
	...
	\subfloat[Denoised \(N_{\sigma}=2\) \newline
		\(\snr{d} = \SI{5.67}{\dB}\)]
	{\includegraphics[trim={22 6 7 1},clip,width=.5\textwidth]{slepian_south_america_snr-10_n2_2smoothed_denoised_L128_res512_real.pdf}}
	\newline
	\subfloat[Denoised \(N_{\sigma}=3\) \newline
		\(\snr{d} = \SI{4.60}{\dB}\)]
	{\includegraphics[trim={22 6 7 1},clip,width=.5\textwidth]{slepian_south_america_snr-10_n3_2smoothed_denoised_L128_res512_real.pdf}}
	\hfill
	\subfloat[Denoised \(N_{\sigma}=5\) \newline
		\(\snr{d} = \SI{1.27}{\dB}\)]
	{\includegraphics[trim={22 6 7 1},clip,width=.5\textwidth]{slepian_south_america_snr-10_n5_2smoothed_denoised_L128_res512_real.pdf}}
	\caption{
