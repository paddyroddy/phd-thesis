...
The wavelet transform follows through a generalisation of the \emph{sifting convolution}~\autocite{Roddy2021}, discussed in \cref{sec:chapter3}, which allows one to perform convolutions on (incomplete) manifolds.
...
As before, Slepian wavelets on manifolds can be used for many standard wavelet applications; for example, solving inverse problems via sparse regularisation~\autocite{McEwen2013a,Wallis2017,Price2021}.
