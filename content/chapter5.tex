...
In \cref{sec:chapter4_generating_functions}, the smooth generating functions which tile the Slepian line to define the wavelets were defined (\cf{}~\autocite{Wiaux2008}).
...
The wavelet generating functions, discussed in \cref{sec:chapter4_generating_functions}, are constructed through the \texttt{S2LET}\footnote{\url{http://astro-informatics.github.io/s2let/}}~\autocite{Leistedt2013} code.
