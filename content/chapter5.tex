...
The wavelet generating functions, discussed in \cref{sec:chapter5_generating_functions}, are constructed through the \texttt{S2LET}\cref{fn:s2let}~\cite{Leistedt2013} code.
