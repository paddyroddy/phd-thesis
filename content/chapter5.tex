...
\end{equation}
%
and the usual expression of the area of a triangle
%
...
\end{equation}
%
Through an analogous expression for the interior angle \(\beta_{i j}\), it is clear that \cref{eq:chapter5_cotangent_laplace} follows from \cref{eq:chapter5_mesh_laplace_weights}~\cite{Meyer2003}.
