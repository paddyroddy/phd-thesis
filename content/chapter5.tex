...
This chapter generalises Slepian scale-discretised wavelets on the sphere~\autocite{Roddy2021a} to Riemannian manifolds.
...
Plainly, wavelets in the Slepian domain have been considered before --- this chapter generalises prior work on the sphere to general manifolds~\autocite{Roddy2021a}.
...
This \emph{cotangent Laplacian} is used extensively in computer graphics~\autocite{Pinkall1993}, and in the rest of this chapter.
...
This chapter generalises Slepian scale-discretised wavelets on the sphere~\autocite{Roddy2021a} to arbitrary manifolds.
...
This chapter generalises the recently developed \emph{Slepian scale-discretised wavelets on the sphere}~\autocite{Roddy2021a} to Riemannian manifolds, whereby the wavelets themselves are restricted to a region of the manifold.
