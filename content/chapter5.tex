...
Note that performing convolutions on manifolds has been considered before; for example, in geometric deep learning, where convolutional neural network (CNN) models have been generalised to graphs through convolutions in the spectral-domain~\cite{Bruna2014,Henaff2015,Defferrard2016}.
...
Similar convolutions on manifolds have been considered before, particularly in the construction of graph CNNs,
