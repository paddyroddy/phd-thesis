...
The sifting convolution may be expressed both in the real and Fourier domains, and as such may handle any set of basis functions.
Moreover, although the Slepian concentration problem was first considered in the one-dimensional Euclidean setting as a time-frequency concentration problem, the Slepian functions may be found for any region of a manifold.
