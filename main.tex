...
%   separate file.
\input{config/MainPackages}

% Sets up links within your document, for contents page entries
%  and references, and also PDF metadata.
% Edit this!
\input{config/LinksAndMetadata}

% And then some settings in separate files.
\input{config/FloatSettings} % For things like figures and tables
\input{config/BibSettings}   % For bibliographies
